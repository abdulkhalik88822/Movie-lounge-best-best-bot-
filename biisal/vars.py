...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN' , '7129593614:AAFRuZc0Av-Yd6gYgFm8_hHNnes3_8OIotQ'))
    name = str(getenv('name', 'File_Press_bot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1001910391568'))
    ...
    FILE_BOT_TOKEN = str(getenv('FILE_BOT_TOKEN', '7523273025:AAEop5oYx3lYUiaDhLTepiV4dKEuKztCE8U'))
